...
const CallToAction = () => {
    return (
        <div className='bg-amber-200 dark:bg-slate-700 my-10 w-full flex flex-col sm:flex-row gap-8 p-5 border border-slate-500 justify-center items-center rounded-md '>
